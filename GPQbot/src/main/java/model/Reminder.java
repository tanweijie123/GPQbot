...
public class Reminder {
    ...
    public Reminder(int id, String gid, String uid, ZonedDateTime createdDate, ZonedDateTime expectedDate,
                    String reminderLink, String sourceLink) {
        this.id = id;
        this.gid = gid;
        this.uid = uid;
    ...
    public String toString() {
        return String.format("(%d, %s, %s, %s, %s, %s, %s", this.id, this.gid, this.uid,
                Utility.toDateTimeString(createdDate), Utility.toDateTimeString(expectedDate),
                this.reminderLink, this.sourceLink);
    }
